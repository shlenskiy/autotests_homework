...
class Segment:
    ...
    def x_axis_intersection(self):
        x_axis_intersection = self.x1 <= 0 and self.x2 >= 0 or self.x2 <= 0 and self.x1 >= 0
        return x_axis_intersection
    def y_axis_intersection(self):
        y_axis_intersection = self.y1 <= 0 and self.y2 >= 0 or self.y2 <= 0 and self.y1 >= 0
        return y_axis_intersection
